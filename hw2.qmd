...
**Due 2025-02-20, 11:59pm**. *Instructions last updated 2025-02-01.*
...
You can use any packages you want for this (scikit-learn, spaCy, NLTK, Gensim, etc., as well as any code from Homework 1 or any in-class example notebook). Any packages used, along with verision numbers, should be specified in a `requirements.txt` file. The version of Python used should also be specified in your `README.txt` file. If you will be using a language other than Python, please let us know before submitting. 
...
This optional competition is conducted on Kaggle. **Check back for more details and a link to the Kaggle page for this competition.**

<!--See these pages for instructions on how to submit: -->
