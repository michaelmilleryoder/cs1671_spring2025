...
**Due 2025-01-23, 11:59pm**. *Instructions last updated 2025-01-22.*
...
You can choose how you split the text into words (tokenize) or otherwise identify the words in the following questions, for example through regular expressions. Any packages may be imported to aid this.
