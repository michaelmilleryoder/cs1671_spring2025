...
**Due 2025-01-23, 11:59pm**. *Instructions last updated 2025-01-09.*
...
You can download it and unpack it as follows:
...
One way of doing this is by formatting the data as a table or spreadsheet with the text in a column and other columns of metadata about that text.

You can use the [`csv` module](https://docs.python.org/3/library/csv.html) or the more powerful [`pandas` package](https://pandas.pydata.org/docs/index.html#), particularly the [`read_csv`](https://pandas.pydata.org/pandas-docs/stable/user_guide/io.html#csv-text-files) and [`to_csv`](https://pandas.pydata.org/pandas-docs/stable/user_guide/io.html#writing-to-csv-format) methods to handle data in this format.

Fill in the `text_to_csv` function in `hw1_skeleton.py`.
In this function, you will read in the `spanish_test.txt` file and produce a CSV file with the following columns:
...
* `character_length`: the number of characters (length) of the line. See the Python [string module](https://pandas.pydata.org/pandas-docs/stable/user_guide/io.html#writing-to-csv-format) or [pandas string functions](https://pandas.pydata.org/docs/user_guide/text.html#string-methods).
