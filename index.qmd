...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>J+M 3-3.3</td>
            <td>Quiz due 01-30,<br/> Project idea submission form due 01-30,<br/>HW2 out</td>
        </tr>
        <tr>
            <td>7</td>
            <td>02-03 M</td>
        ...
        <tr>
            ...
            <td>Tf-idf, PPMI</td>
            <td>J+M 6.5-6.7</td>
            <td>Quiz due 02-06,<br/> Project idea ranking form due 02-06</td>
        </tr>
        <tr>
            <td>9</td>
            <td>02-10 M</td>
