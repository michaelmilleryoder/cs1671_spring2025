...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>J+M 3-3.3</td>
            <td>Quiz due 01-30,<br/><strong>Project idea submission form due 01-30</strong>,<br/>HW2 out</td>
        </tr>
        <tr>
            <td>7</td>
            <td>02-03 M</td>
        ...
        <tr>
            ...
            <td>Tf-idf, PPMI</td>
            <td>J+M 6.5-6.7</td>
            <td>Quiz due 02-06,<br/><strong>Project idea ranking form due 02-06</strong></td>
        </tr>
        <tr>
            <td>9</td>
            <td>02-10 M</td>
        ...
        <tr>
            ...
            <td></td>
            <td>Quiz due 03-13,<br/>HW3 out</td>
        </tr>
        <tr>
            <td>17</td>
            <td>03-17 M</td>
