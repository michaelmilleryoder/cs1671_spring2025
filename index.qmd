...
# Schedule
*Subject to change. Last revised 2025-01-02. All due dates are at 11:59pm ET except when indicated.*
...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            <td>3</td>
            <td>01-15 W</td>
            <td><a href="slides/session3_cs1671_spring2025.pdf">Linear algebra, probability review for NLP</a></td>
            <td></td>
            <td></td>
        </tr>
        ...
        <tr>
            <td>4</td>
            <td>01-22 W</td>
            <td>Machine learning intro, NLP tasks and applications</td>
            <td></td>
            <td><strong><a href="hw1">HW1</a> due 01-23</strong>,<br/>Project idea submission form out</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>5</td>
            <td>01-27 M</td>
            <td>Bag-of-words and n-grams</td>
            <td>J+M 6.3-6.4</td>
            <td></td>
        </tr>
        <tr>
            ...
            <td>J+M 3-3.3</td>
            <td><strong>Quiz due 01-30</strong>,<br/><strong>Project idea submission form due 01-30</strong>,<br/>HW2 out</td>
        </tr>
        <tr>
            <td>7</td>
            <td>02-03 M</td>
...
&ensp;Project idea submission form | 5 | 0.5
...
The instructor reserves the right to change the grading scale depending on class performance, but only in the direction of raising grades for students. Feel free to contact the instructor or schedule an office hours appointment to talk about any issues you might have with your grade.
