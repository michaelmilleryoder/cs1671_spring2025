...
# Schedule
*Subject to change. Last revised 2025-01-24. All due dates are at 11:59pm ET except when indicated.*
...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>J+M 3-3.3</td>
            <td><strong>Quiz due 01-30</strong>,<br/><strong><a href="https://forms.office.com/r/eZ1djDScD0">Project idea submission form</a> due 01-30</strong>,<br/>HW2 out 01-30</td>
        </tr>
        <tr>
            <td>7</td>
            <td>02-03 M</td>
        ...
        <tr>
            <td>9</td>
            <td>02-10 M</td>
            <td>Text classification, logistic regression part 1</td>
            <td>J+M 4 (intro), 5-5.2</td>
            <td></td>
        </tr>
        <tr>
            <td>10</td>
        ...
        <tr>
            <td>11</td>
            <td>02-17 M</td>
            <td>Logistic regression part 3</td>
            <td>J+M 5.9, 5.11</td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td></td>
            <td><strong>HW2 due 02-20</strong></td>
        </tr>
        <tr>
            <td>13</td>
            <td>02-24 M</td>
