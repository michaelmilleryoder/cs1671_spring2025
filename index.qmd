...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Project idea ranking form out</td>
        </tr>
        <tr>
            <td>8</td>
            <td>02-05 W</td>
            <td>Tf-idf, PPMI</td>
            <td>J+M 6.5-6.7</td>
            <td><strong>Quiz due 02-06</strong>,<br/><strong>Project idea ranking form due 02-06</strong></td>
        </tr>
        <tr>
            <td>9</td>
            <td>02-10 M</td>
...
&ensp;Project idea ranking form | 5 | 0.5
&ensp;Project proposal | 60 | 6
&ensp;Project progress report | 40 | 4
